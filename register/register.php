                    ...
                    <div class="row row-space">
                        <div class="col-2">
                            <div class="input-group">
                                ...
                                <input class="input--style-4" type="text" id="fname" name="fname" autofocus required>
                            </div>
                        </div>
                        <div class="col-2">
                            <div class="input-group">
                                <label class="label">last name</label>
                                <input class="input--style-4" type="text" id="lname" name="lname" required>
                            </div>
                        </div>
                    </div>
                    <div class="row row-space">
                    ...
                    <div class="row row-space">
                        <div class="col-2">
                            <div class="input-group">
                                ...
                                <input class="input--style-4" type="password" id="password1" name="password1" required>
                            </div>
                        </div>
                        <div class="col-2">
                            <div class="input-group">
